"""
Defines a Ray worker that sends text chunks to an LLM to extract knowledge-graph entities and relationships, then returns nodes and edges for each chunk.
"""
